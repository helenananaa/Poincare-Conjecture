...
namespace PoincareConjecture.ParallelImplementation.RadiusControlledC3Extension
open scoped Topology BigOperators ContDiff Manifold BoundedContinuousFunction
local notation "E3" => EuclideanSpace ℝ (Fin 3)
local notation "E6" => EuclideanSpace ℝ (Fin 6)
theorem exists_radius_controlled_c3_extension
...
by
  ...
  refine ⟨r, hrpos, hrone, hrrmax, U, hUcont, hUcompact, ?_, ?_, ?_, ?_, ?_, ?_⟩
  · intro x hx
...
/- SWARM_PROOF_END -/
end PoincareConjecture.ParallelImplementation.RadiusControlledC3Extension
