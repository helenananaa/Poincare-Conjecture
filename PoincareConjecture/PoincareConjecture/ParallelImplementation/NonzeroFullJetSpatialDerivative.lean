...
namespace PoincareConjecture.ParallelImplementation.NonzeroFullJetSpatialDerivative
...
as a full parabolic jet, retaining arbitrary original initial trace. No norm convergence or derivative
jet witness is assumed. -/
theorem exists_actual_nonzero_spatial_derivative_jet
    (T alpha : ℝ) (hT : 0 < T) (ha : 0 < alpha) (ha1 : alpha ≤ 1)
    (z : FullJet T) (hz : (z.1.1 ∈ PoincareConjecture.ParallelImplementation.ParabolicC2HolderJet.parabolicC2HolderSet T alpha ∧
      (z.1.1.1.1, z.1.2) ∈ PoincareConjecture.ParallelImplementation.SlabTimeDerivativeGraph.slabTimeDerivativeGraph T ∧
      (∀ p : PoincareConjecture.ParallelImplementation.ParabolicC2HolderJet.Pair T, z.2 p =
    ...
    ∃ dz : FullJet T,
      (dz.1.1 ∈ PoincareConjecture.ParallelImplementation.ParabolicC2HolderJet.parabolicC2HolderSet T alpha ∧
      (dz.1.1.1.1, dz.1.2) ∈ PoincareConjecture.ParallelImplementation.SlabTimeDerivativeGraph.slabTimeDerivativeGraph T ∧
      (∀ p : PoincareConjecture.ParallelImplementation.ParabolicC2HolderJet.Pair T, dz.2 p =
        (PoincareConjecture.ParallelImplementation.ParabolicC2HolderJet.parabolicRho p.1.1 p.1.2 ^ alpha)⁻¹ •
          (dz.1.2 p.1.1 - dz.1.2 p.1.2))) ∧ ‖dz‖ ≤ C ∧
...
by
  ...
  have htimeIncZ : ∀ p : PoincareConjecture.ParallelImplementation.ParabolicC2HolderJet.Pair T,
      z.2 p = (PoincareConjecture.ParallelImplementation.ParabolicC2HolderJet.parabolicRho p.1.1 p.1.2 ^ alpha)⁻¹ •
        (z.1.2 p.1.1 - z.1.2 p.1.2) := hz.2.2
  ...
  have hqFull (n : ℕ) : ((q n).1.1 ∈ PoincareConjecture.ParallelImplementation.ParabolicC2HolderJet.parabolicC2HolderSet T alpha ∧
    ...
    ⟨hqHolder n, hqTime n, hqTimeInc n⟩
  ...
  have hdzTimeInc : ∀ p : PoincareConjecture.ParallelImplementation.ParabolicC2HolderJet.Pair T,
    ...
    intro p
    rfl
  have hdzMem : (dz.1.1 ∈ PoincareConjecture.ParallelImplementation.ParabolicC2HolderJet.parabolicC2HolderSet T alpha ∧
      (dz.1.1.1.1, dz.1.2) ∈ PoincareConjecture.ParallelImplementation.SlabTimeDerivativeGraph.slabTimeDerivativeGraph T ∧
      (∀ p : PoincareConjecture.ParallelImplementation.ParabolicC2HolderJet.Pair T, dz.2 p =
        (PoincareConjecture.ParallelImplementation.ParabolicC2HolderJet.parabolicRho p.1.1 p.1.2 ^ alpha)⁻¹ •
          (dz.1.2 p.1.1 - dz.1.2 p.1.2))) :=
    ⟨hdzSpace, hdzTime, hdzTimeInc⟩
...
/- SWARM_PROOF_END -/
end PoincareConjecture.ParallelImplementation.NonzeroFullJetSpatialDerivative
