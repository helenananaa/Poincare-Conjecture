...
import PoincareConjecture.ParallelImplementation.SmoothNormalizedSixMetricCoordinates
...
import PoincareConjecture.ParallelImplementation.SmoothRadiusControlledClassicalDeTurck
set_option autoImplicit false
noncomputable section
namespace PoincareConjecture.ParallelImplementation.SmoothManifoldChartClassicalInitialSolution
...
theorem exists_manifold_chart_smooth_initial_solution
    ...
    ∃ U : E3 → E6, ContDiff ℝ ∞ U ∧ HasCompactSupport U ∧
      (∀ x : E3, 2 ≤ ‖x‖ → U x=0) ∧
      (∀ x : E3, ‖x‖ ≤ 1 →
...
by
  ...
  obtain ⟨A, u, hu, hu0, hnormalize⟩ :=
    PoincareConjecture.ParallelImplementation.SmoothNormalizedSixMetricCoordinates.exists_smooth_normalized_six_metric_coordinates
      E0 hE0action M hMsmooth hMsym y0 (fun v hv => hMpos y0 v hv)
  ...
  obtain ⟨E1, hE1inj, hE1norm, hE1action, r, T, hrpos, hrle, hrmax',
    ...
    PoincareConjecture.ParallelImplementation.SmoothRadiusControlledClassicalDeTurck.exists_smooth_radius_controlled_classical_deturck
...
/- SWARM_PROOF_END -/
end PoincareConjecture.ParallelImplementation.SmoothManifoldChartClassicalInitialSolution
